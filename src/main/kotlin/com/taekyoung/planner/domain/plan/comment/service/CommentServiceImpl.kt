...
class CommentServiceImpl(
    ...
    @Transactional
    override fun createComment(request: CommentRequest, memberId: Long, planId: Long): CommentResponse {
    ...
    @Transactional
    override fun updateComment(commentId: Long, memberId: Long, request: CommentRequest): CommentResponse {
        val comment = commentRepository.findByIdAndDeletedAtIsNull(commentId) ?: throw ModelNotFoundException(
            "comment",
            commentId
        )
