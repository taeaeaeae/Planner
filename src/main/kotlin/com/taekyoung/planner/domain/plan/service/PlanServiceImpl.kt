...
class PlanServiceImpl(
    ...
    override fun getPlanById(planId: Long): PlanDetailResponse {
    ...
    @Transactional
    override fun createPlan(request: PlanRequest, memberId: Long): PlanResponse {
    ...
    @Transactional
    override fun updatePlan(planId: Long, memberId: Long, request: UpdatePlanRequest): PlanResponse {
        val plan = planRepository.findByIdAndDeletedAtIsNull(planId) ?: throw ModelNotFoundException("plan", planId)
    ...
    @Transactional
    override fun deletePlan(planId: Long, memberId: Long) {
        val plan = planRepository.findByIdAndDeletedAtIsNull(planId) ?: throw ModelNotFoundException("plan", planId)
        if (plan.member.id != memberId) throw AccessDeniedException("You are not have this plan")
        plan.deletePlan()
    }
